...
switch(n.getAttribute("data-action")){
	case"remove":
		...
		//cuenta
		settingsremover = document.getElementById("ef_form_2519_formularioremover"); 
        if(settingsremover != null){
        	settingsremover.value='1';
        }  

 		//empresas
 		settingsremover = document.getElementById("ef_form_2484_formularioremover"); 
        if(settingsremover != null){
        	settingsremover.value='1';
        }
 		...
 		//grupos
 		settingsremover = document.getElementById("ef_form_2476_formularioremover1"); 
        if(settingsremover != null){
        	settingsremover.value='1';
        }
 		
 		settingsremover = document.getElementById("ef_form_2476_formularioremover2"); 
        if(settingsremover != null){
        	settingsremover.value='1';
        }

 		settingsremover = document.getElementById("ef_form_2476_formularioremover3"); 
        if(settingsremover != null){
        	settingsremover.value='1';
        }
 		
 		settingsremover = document.getElementById("ef_form_2476_formularioremover4"); 
        if(settingsremover != null){
        	settingsremover.value='1';
        }

 		settingsremover = document.getElementById("ef_form_2476_formularioremover5"); 
        if(settingsremover != null){
        	settingsremover.value='1';
        }

        //incidentes
 		settingsremover = document.getElementById("ef_form_2498_formularioremover"+this.data.input.name.substring(2,3));
        if(settingsremover != null){
        	settingsremover.value='1';
        }

        //rondines
 		settingsremover = document.getElementById("ef_form_2563_formularioremover"+this.data.input.name.substring(2,3));
        if(settingsremover != null){
        	settingsremover.value='1';
        }

        //sanciones
 		settingsremover = document.getElementById("ef_form_2934_formularioremover"+this.data.input.name.substring(2,3));
        if(settingsremover != null){
        	settingsremover.value='1';
        }
 		settingsremover = document.getElementById("ef_form_2935_formulario_edicionremover"+this.data.input.name.substring(2,3));
        if(settingsremover != null){
        	settingsremover.value='1';
        }

        //personal 
 		settingsremover = document.getElementById("ef_form_2511_form_basicosremover");
        if(settingsremover != null){
        	settingsremover.value='1';
        }

        //usuario
 		settingsremover = document.getElementById("ef_form_2337_formularioremover");
        if(settingsremover != null){
        	settingsremover.value='1';
        }


		//alert(this.data.input.name);
		//alert(this.data.input.name.substring(2,3)); 

		this._options.willRemove.apply(this,[this.data,function(){e._doRemove()}]);
		break;
	case"edit":this._doEdit();
		break;
	case"download":
		this._doDownload();
		break;
